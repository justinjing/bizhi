...
- (void)configureWithViewModel:(BZWaterfallViewCellModel *)viewModel
{
    ...
    @weakify(self)
    [self.thumbnailImageView setImageWithURL:imageURL placeholderImage:nil options:SDWebImageRetryFailed progress:^(NSInteger receivedSize, NSInteger expectedSize) {
